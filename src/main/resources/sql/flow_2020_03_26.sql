/*
 ...
 Source Server         : a_jd_114.67.95.131
...
) ENGINE = InnoDB AUTO_INCREMENT = 558 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '夫路' ROW_FORMAT = Dynamic;
...
CREATE TABLE `schedule`  (
  ...
  `uuid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '唯一码',
  `user_id` bigint(20) NOT NULL COMMENT '用户ID',
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '哪一天',
  `content` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL COMMENT '具体事情',
  `a` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL COMMENT 'a项',
  `b` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL COMMENT 'b项',
  `c` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL COMMENT 'c项',
  `d` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL COMMENT 'd项',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_userId`(`user_id`) USING BTREE,
  UNIQUE INDEX `uidx_uuid`(`uuid`) USING BTREE
