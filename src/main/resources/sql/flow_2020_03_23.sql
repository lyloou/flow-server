...
) ENGINE = InnoDB AUTO_INCREMENT = 550 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '夫路' ROW_FORMAT = Dynamic;
...
create TABLE `schedule`  (
  ...
  `is_disabled` tinyint(1) NULL DEFAULT 0 COMMENT '是否已经删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uidx_userId_day`(`user_id`, `title`) USING BTREE,
  INDEX `idx_userId`(`user_id`) USING BTREE
